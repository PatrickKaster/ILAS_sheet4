				...
				\item 
					\begin{description}
						...
						\item[Identity of indiscernibles] 
							...
							\end{align}
							and
							Let $D_\Delta(A,B) = 0$ from that follows \todo{Do we need these equations to be numbered? We need ALL the numbers :D}
							\begin{align}
						...
						\item[triangle inequality]							
							...
							\todo{Alternate version of proof,maybe nicer without the cases}
							\begin{align}
